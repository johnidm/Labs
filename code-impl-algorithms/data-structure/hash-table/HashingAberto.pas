...
var
  IndiceHash: Integer;
  PAuxiliar, PAnterior: PComputador;
begin
  // Cálculo do hash
  ...
  begin
    ...
    begin
      ...
      if ( PAuxiliar.Codigo = AComputador.Codigo ) then
        raise Exception.Create('Código já cadastrado');
    ...
    // Incluindo o primeiro índice na tabela
    if (HashTable[ IndiceHash ].Apontador = nil) then
      HashTable[ IndiceHash ].Apontador:= PAuxiliar
    else
      PAnterior.Apontador:= PAuxiliar;

...
public class TokenAuthenticationService {
    ...
    static final long EXPIRATION_TIME = (long) MILLIS_IN_SECOND * SECONDS_IN_MINUTE * MINUTES_IN_HOUR * HOURS_IN_DAY
            * DAYS_IN_YEAR * YEARS;
    ...
    public static void addAuthentication(HttpServletResponse response, String username) {
        String JWT = TokenAuthenticationService.generateToken(username);
